...
const greets=[
    {
        greet:"Let's Rock",
        msg:"Create an account or log in to keep using Trapflix!"
    },
    {
...
const clientId="870668582973-a9god2gt8n7in07tq9egrkv47kkida5d.apps.googleusercontent.com";
   ...
   const user=useSelector((state)=>state.Auth.user);
    ...
    return (
        ...
        <Wrapper>
           ...
           <Text color="red" family="Poppins" size="1.0em" padding="0 20px 50px 20px">{greets[index].msg}</Text>
            ...
            <br/>
            <Text color="red" style={{textDecoration:'underline'}}family="Poppins" size="1.2em" bold="600" onClick={()=>{history.push('/home')}}>Skip</Text>
