    ...
    return (
      <>
        <Wrapper>
          ...
          <IconWrapper>
            <Icon background="black" width="50px" height="50px" color="white" BorderRadius="50%"> <i class="fa fa-heart"></i></Icon>
          ...
          <Text color="red" family="Poppins" size="0.9em" padding="5px 0 0 20px">{data.songs[0].header_desc}</Text>
          
          {/* section for download and share and plays */}
          <Flexbox>
          <Icon background="black" size="13px" width="25px" height="25px" color="white" BorderRadius="50%"><i class="fa fa-arrow-down"></i></Icon>
          <Icon background="black" size="13px" width="25px" height="25px" color="white" BorderRadius="50%" onClick={()=>share({title:"Trapflix",url:window.location.href,text:"Listen To "+data.songs[0].title})}><i class="fa fa-share-alt"></i></Icon>
          <Text color="red" family="Poppins" size="0.8em">{parseInt(data.songs[0].play_count).toLocaleString('en-US')} Plays</Text>
          </Flexbox>
         ...
         {/* Bottom footer */}
         <Footer>
           <Text color="red" family="Poppins" size="0.8em">{new Date(data.songs[0].more_info.duration).toISOString().substr(14, 5)}</Text>
           <Text color="red" family="Poppins" size="0.8em">{data.songs[0].more_info.copyright_text}</Text>
         </Footer>
