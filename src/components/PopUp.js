        ...
        <Wrapper>
            ...
            <ImageWrapper padding="30px 0 10px 0">
             ...
             <TextWrapper>
                ...
                <Text color="red"  family="Poppins" size="0.8em">{props.data.description || props.data.subtitle}</Text>
             </TextWrapper>
            ...
            <Icon tobottom={true} BorderRadius="15px" width="100%" height="50px" size="1.2em" background="black" color="white" onClick={()=>props.setopen(false)}>Close</Icon>
...
const Wrapper=styled.div`
   box-shadow:0px 0px 20px inset red;
  display: block; 
  position: fixed; 
  z-index: 1; 
  left: 0;
