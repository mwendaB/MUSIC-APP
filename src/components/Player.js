    ...
    return (
        <Wrapper>
           ...
           <LyricsWrapper>
            ...
            <Text color="red" family="Poppins" size="0.9em" padding="0 0 0 20px">{song.description}</Text>
            <ProgressBarWrapper>
                <ProgressBar id="seeker" type="range" value={seekerpos} max="0" onChange={onseekerchange}/>
                <Timer>
                <Text color="red" family="Poppins" size="0.9em" padding="0 0 0 0" id="start">00:00</Text>
                <Text color="red" family="Poppins" size="0.9em" padding="0 0 0 20px" id="end">NaN</Text>
                </Timer>
            </ProgressBarWrapper>
