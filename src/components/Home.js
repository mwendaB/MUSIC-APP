...
function Home() {
    ...
    if(loading || !data){
        return <><Header title="Trapflix"/><Loading/><Menubar/></>
    }
    ...
    return (
        ...
        <Wrapper>
         ...
         <Section id="trending">
            ...
            <Text color="red" family="Poppins" size="0.8em"  padding="0 0 10px 20px">TRENDING THIS WEEK</Text>
            <SliderWrapper>
                <Flexbox >
         ...
         <Section id="playlists">
            ...
            <Text color="red" family="Poppins" size="0.8em"  padding="0 0 10px 20px">TOP PLAYLISTS</Text>
            <SliderWrapper>
                <Flexbox>
