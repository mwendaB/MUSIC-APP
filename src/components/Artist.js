...
if(loading===false && !data.artistId){
    ...
    return (
        ...
        <Wrapper>
          ...
          <Icon background="black" size="13px" width="25px" height="25px" color="white" BorderRadius="50%" onClick={()=>share({title:"Trapflix",url:window.location.href,text:data.name+data.subtitle})}><i class="fa fa-share-alt"></i></Icon>
          <Text color="red" family="Poppins" size="0.9em">{data.subtitle}</Text>
          </Flexbox>
